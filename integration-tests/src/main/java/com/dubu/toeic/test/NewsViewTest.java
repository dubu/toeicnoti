...
package com.dubu.toeic.test;

import static com.dubu.toeic.core.Constants.Extra.NEWS_ITEM;
import android.content.Intent;
import android.test.ActivityInstrumentationTestCase2;

import com.dubu.toeic.core.News;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link com.dubu.toeic.ui.CarouselActivity}
     */
    public NewsViewTest() {
