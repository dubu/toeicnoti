...
public class RunSchedule {
    ...
    public static  void main(String[] args){
        ...
        sche.put("2014-04-02",URLEncoder.encode("발표일14.04.03(목) 오후 3시"));
        sche.put("2014-04-17",URLEncoder.encode("발표일14.04.18(금) 오후 3시"));
        sche.put("2014-05-15",URLEncoder.encode("발표일14.05.16(금) 오후 3시"));
        sche.put("2014-05-28",URLEncoder.encode("발표일14.05.29(목) 오후 3시"));
        sche.put("2014-06-12",URLEncoder.encode("발표일14.06.13(금) 오후 3시"));
        sche.put("2014-07-17",URLEncoder.encode("발표일14.07.18(금) 오후 3시"));
        sche.put("2014-07-30",URLEncoder.encode("발표일14.07.31(목) 오후 3시"));
        sche.put("2014-08-14",URLEncoder.encode("발표일14.08.15(금) 오후 3시"));
        sche.put("2014-08-27",URLEncoder.encode("발표일14.08.28(목) 오후 3시"));
        sche.put("2014-09-18",URLEncoder.encode("발표일14.09.19(금) 오후 3시"));
        sche.put("2014-10-16",URLEncoder.encode("발표일14.10.17(금) 오후 3시"));
        sche.put("2014-10-29",URLEncoder.encode("발표일14.10.30(목) 오후 3시"));
        sche.put("2014-11-13",URLEncoder.encode("발표일14.11.14(금) 오후 3시"));
        sche.put("2014-12-18",URLEncoder.encode("발표일14.12.19(금) 오후 3시"));
        sche.put("2015-01-08",URLEncoder.encode("발표일15.01.09(금) 오후 3시"));

        sche.put("2014-03-30", URLEncoder.encode("발표일 ~14.03.31(월) 오전 8시"));
        sche.put("2014-04-13", URLEncoder.encode("발표일 ~14.04.14(월) 오전 8시"));
        sche.put("2014-04-27", URLEncoder.encode("발표일 ~14.04.28(월) 오전 8시"));
        sche.put("2014-05-26", URLEncoder.encode("발표일 ~14.05.26(월) 오전 8시"));
        sche.put("2014-06-15", URLEncoder.encode("발표일 ~14.06.16(월) 오전 8시"));
        sche.put("2014-06-29", URLEncoder.encode("발표일 ~14.06.30(월) 오전 8시"));
        sche.put("2014-07-13", URLEncoder.encode("발표일 ~14.07.14(월) 오전 8시"));
        sche.put("2014-07-27", URLEncoder.encode("발표일 ~14.07.28(월) 오전 8시"));
        sche.put("2014-08-31", URLEncoder.encode("발표일 ~14.09.01(월) 오전 8시"));
        sche.put("2014-09-14", URLEncoder.encode("발표일 ~14.09.15(월) 오전 8시"));
        sche.put("2014-09-28", URLEncoder.encode("발표일 ~14.09.29(월) 오전 8시"));
