...
This repository contains the source code for the [toeicnoti](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.dubu.toeic).

Please see the [issues](https://github.com.dubu.toeic/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about toeicnoti? Ask away on the [com-dubu-toeic discussion forum](https://groups.google.com/forum/#!forum/com-dubu-toeic). 

<a href="https://play.google.com/store/apps/details?id=com.dubu.toeic" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.dubu.toeic__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.dubu.toeic__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.dubu.toeic.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall toeicnoti from your device and
you will then be able to install your own built version.

## Acknowledgements

toeicnoti is a result of a template project I've developed over the years as well as
...
toeicnoti is built on the awesome [Parse.com API](http://www.parse.com/)
...
[pull requests](https://github.com.dubu.toeic/pulls).
